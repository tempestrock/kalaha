...
// StorageHelper
//
// A helper class by Jerry Nixon for an easy file access.
//
...
namespace PST_Common
{
    public static class StorageHelper
    {
        ...
        /// <summary>Serializes an object and writes to file in specified storage strategy</summary>
        /// <typeparam name="T">Specified type of object to serialize</typeparam>
        /// <param name="key">Path to the file in storage</param>
        /// <param name="value">Instance of object to be serialized and written</param>
        /// <param name="location">Location storage strategy</param>
        ...
        /// <summary>Serializes an object and appends to file in specified storage strategy</summary>
        /// <typeparam name="T">Specified type of object to serialize</typeparam>
        /// <param name="key">Path to the file in storage</param>
        /// <param name="_String">A string to be written</param>
        /// <param name="location">Location storage strategy</param>
        public static async Task<bool> AppendFileAsync<T>(string key, string _String, StorageStrategies location = StorageStrategies.Local)
        {
            // create file
            var _File = await CreateFileAsync(key, location, Windows.Storage.CreationCollisionOption.OpenIfExists);
            // save string to file
            await Windows.Storage.FileIO.AppendTextAsync(_File, _String);
            // result
            return await FileExistsAsync(key, location);
        }
        ...
        /// <param name="value">Instance of object to be serialized and written</param>
        /// <param name="location">Location storage strategy</param>
        public static async Task<bool> AppendFileAsync<T>(string key, T value, StorageStrategies location = StorageStrategies.Local)
        {
            // create file
            var _File = await CreateFileAsync(key, location, Windows.Storage.CreationCollisionOption.OpenIfExists);
            // convert to string
